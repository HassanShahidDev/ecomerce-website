    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='text-xl sm:text-2xl my-3'>
          <Title text1={'DDELIVER'} text2={'INFORMATIOM'} />
        ...
        <input required onChange={onChangeHandler} name='email' value={formData.email} className='border border-gray-300 rounded py-1.5 px-3 w-full' type="email" placeholder='EMAIL ADRESS' />
        ...
        <div className='flex gap-3'>
          <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode} className='border border-gray-300 rounded py-1.5 px-3 w-full' type="number" placeholder='Zip Code' />
        ...
        <input required onChange={onChangeHandler} name='phone' value={formData.phone} className='border border-gray-300 rounded py-1.5 px-3 w-full' type="number" placeholder='phone' />
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p-3 px-3 cursor-pointer'>
            ...
            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border p-3 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'cod' ? 'bg-green-400' : ''}`}></p>
              <p className='text-gray-500 text-sm fontmedium mx-4'> CASH ON DELIVERY</p>
